...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['name' => 'David', 'email' => 'david@company.com', 'role' => 'program_manager', 'color' => '#8b5cf6'],
        ...
        $createdProjects[0]->update([
            ...
            'program_manager_id' => $createdUsers[2]->id,
        ]);
        ...
        $logData = [
            ...
            ['ts_idx' => 0, 'user_id' => 3, 'action' => 'approved_program_manager', 'comment' => 'Final approved', 'offset' => 3],
            ['ts_idx' => 1, 'user_id' => 4, 'action' => 'submitted', 'comment' => '', 'offset' => 1],
            ['ts_idx' => 1, 'user_id' => 2, 'action' => 'approved_pm', 'comment' => 'Approved', 'offset' => 2],
            ['ts_idx' => 1, 'user_id' => 3, 'action' => 'approved_program_manager', 'comment' => '', 'offset' => 3],
            ['ts_idx' => 2, 'user_id' => 1, 'action' => 'submitted', 'comment' => '', 'offset' => 1],
            ['ts_idx' => 2, 'user_id' => 2, 'action' => 'approved_pm', 'comment' => '', 'offset' => 2],
            ['ts_idx' => 2, 'user_id' => 3, 'action' => 'approved_program_manager', 'comment' => 'Approved', 'offset' => 3],
