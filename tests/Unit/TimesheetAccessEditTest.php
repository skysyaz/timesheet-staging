...
class TimesheetAccessEditTest extends TestCase
{
    ...
    public function test_manager_cannot_edit_other_users_draft_timesheet(): void
    {
    ...
    public function test_project_manager_can_edit_own_draft_timesheet(): void
    {
        $pm = new User(['id' => 3, 'role' => 'project_manager']);
        $timesheet = new Timesheet(['user_id' => 3, 'status' => 'draft']);
